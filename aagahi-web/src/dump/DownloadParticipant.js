...
class DownloadFile extends React.Component {
	...
	downloadDonorData = () => {
		fetch('http://ihs.ihsinformatics.com:9990/aahung-aagahi/api/report/donors.csv', { 'headers': {
            'Authorization': this.rest_header,
            }} )
			.then(response => {
	...
	downloadDefinitionData = () => {
		fetch('http://ihs.ihsinformatics.com:9990/aahung-aagahi/api/report/definitions.csv', { 'headers': {
            'Authorization': this.rest_header,
            }} )
			.then(response => {
				response.blob().then(blob => {
	...
	downloadElementTypeData = () => {
		fetch('http://ihs.ihsinformatics.com:9990/aahung-aagahi/api/report/elements.csv', { 'headers': {
            'Authorization': this.rest_header,
            }} )
			.then(response => {
				response.blob().then(blob => {
	...
	downloadLocationData = () => {
		fetch('http://ihs.ihsinformatics.com:9990/aahung-aagahi/api/report/locations.csv', { 'headers': {
            'Authorization': this.rest_header,
            }} )
			.then(response => {
				response.blob().then(blob => {
	...
	downloadProjectData = () => {
		fetch('http://ihs.ihsinformatics.com:9990/aahung-aagahi/api/report/projects.csv', { 'headers': {
            'Authorization': this.rest_header,
            }} )
			.then(response => {
				response.blob().then(blob => {
