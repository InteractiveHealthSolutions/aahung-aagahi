...
class SchoolDetailsC extends React.Component {
    ...
    cancelCheck = () => {
        ...
        // document.getElementById("page2").hide();
        // $("page2").hide();
                                                            ...
                                                            <Row>
                                                                ...
                                                                <Col md="3">
                                                                    ...
                                                                    <Label for="school_level" >Level of Program</Label>
                                                                        <Input type="select" name="school_level" id="school_level">
