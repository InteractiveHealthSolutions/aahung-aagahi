...
import "../index.css";
import { getAllRoles, getUserByRegexValue, getUsersByRole, getUsersByName } from '../service/GetService';
...
class UserSearch extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
            <MDBCardHeader style={{backgroundColor: "#025277", color: "white"}}><h5><b>user Search</b></h5></MDBCardHeader>
                <MDBCardBody>
