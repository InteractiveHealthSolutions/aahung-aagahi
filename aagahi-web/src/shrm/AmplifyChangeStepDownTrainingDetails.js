                                                        ...
                                                        <TabContent activeTab={this.state.activeTab}>
                                                            <TabPane tabId="1">
                                                                ...
                                                                <Row>
                                                                    <Col md="6" >
                                                                        <FormGroup >
                                                                            <Label for="event_attendant" >Type of participants attending <span className="required">*</span></Label> <span class="errorMessage">{this.state.errors["event_attendant"]}</span>
                                                                    ...
                                                                    <Col md="6" >
                                                                        <FormGroup >
                                                                            <Label for="participants_age_group" >Age of participants <span className="required">*</span></Label> <span class="errorMessage">{this.state.errors["participants_age_group"]}</span>
