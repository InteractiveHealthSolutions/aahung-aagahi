    ...
    handleSubmit = async event => {
        ...
        if(this.handleValidation()) {
            ...
            try{
                ...
                attributeObject.attributeValue = this.state.participant_type; // attributeValue obj
                jsonData.person.attributes.push(attributeObject);
                ...
                // var years = moment().diff(this.state.partnership_start_date, 'years');
                attributeObject.attributeValue = this.state.instituition_role; // attributeValue obj
                jsonData.person.attributes.push(attributeObject);
