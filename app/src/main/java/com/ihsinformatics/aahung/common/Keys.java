...
public class Keys {
    ...
    public static String comms_training_details_communications = "comms_training_details_communications";
    public static String comms_social_media_details = "comms_social_media_details";
    public static String lse_one_touch_session_detail = "lse_one_touch_session_detail";
    public static String lse_primary_monitoring_running = "lse_primary_monitoring_running";
    public static String lse_primary_monitoring_exit = "lse_primary_monitoring_exit";
}
