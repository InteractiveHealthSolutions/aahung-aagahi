...
public class BaseTestData {
	...
	public void initDefinitionTypes() {
		int count = 100;
		locationType = DefinitionType.builder().definitionTypeId(count++).typeName("Location Type").shortName("LOC_TYPE")
		        .build();
	...
	public void initDefinitions() {
		...
		scotland = Definition.builder().definitionType(country).definitionId(count++).definitionName("Scotland")
		        .shortName("SC").build();
		france = Definition.builder().definitionType(country).definitionId(count++).definitionName("France").shortName("FR")
		        .build();
	...
	public void initLocationAttributes() {
		...
		noOfHogwartzTeachers = LocationAttribute.builder().attributeId(3).location(hogwartz).attributeType(noOfTeachers)
